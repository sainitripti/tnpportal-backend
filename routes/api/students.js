...
router.put('/:id', adminAuth, (req, res) => {
    Student.findById(req.params.id, function(err, student) {
        if (!student)
            ...
            student.activeBacklogs = req.body.activeBacklogs;
            student.deadBacklogs = req.body.deadBacklogs;
            ...
            student.companyName = req.body.companyName;
            student.source = req.body.source;
            student.role = req.body.role;
            student.ctc = req.body.ctc;
            student.isMassRecruitment = req.body.isMassRecruitment;
